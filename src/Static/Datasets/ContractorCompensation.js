...
class ContractorCompensation extends Component {
  constructor(props) {
    super(props);
    this.state = {
      datasetId: '',
    ...
    return (
      <Fragment>
        <Helmet>
          ...
          <link
            rel="canonical"
            href="https://www.open990.org/datasets/contractor_compensation/"
          />
        </Helmet>
            ...
            <Grid container justify="center">
              ...
              <Grid item xs={12}>
                <p className={classes.textContent}>
                  ...
                  contractors. With this free* dataset, you can explore the most
                  highly compensated contractors of services (including
                ...
                <p className={classes.textContent}>
                  ...
                  $100,000—along with their compensation and service
