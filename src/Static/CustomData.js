  ...
  return (
    <Fragment>
      <Helmet>
        ...
        <meta name="description" content="For researchers, grantseekers, marketers, and nonprofit leaders. Choose from hundreds of variables." />
        <meta name="robots" content="all"/>
        <link rel="canonical" href="https://appliednonprofitresearch.com/customdata/" />
      </Helmet>
        ...
        <MaxContainer>
          <Grid container className={classes.staticMainContent} justify="center">
            <Grid item xs={12} md={10} className={classes.underlinedHeader}>
              <h3>IRS nonprofit data <span>•</span> 1.9 million organizations <span>•</span> 5.4 million filings</h3>
            </Grid>
            ...
            <Grid item xs={12} md={10} className={classes.lineText}>
              <p>The most data are available for organizations that file tax returns electronically, but some data (e.g.,
                total assets, NTEE codes) are available for organizations that paper-file 990s.</p>
            </Grid>
